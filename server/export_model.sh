...
#
# 480x640 is exactly half of a 1280x960 camera frame, so the detector feeds it with no resize.
# For a different camera aspect ratio, pick a size with the same shape (both multiples of 32).
