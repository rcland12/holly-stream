...
Watches the MediaMTX ingest for cameras that ask for detection (DETECTION=true on the Pi, sent as detect=1 in the
camera's SRT stream id). When such a camera connects, a worker process is started for it and publishes
